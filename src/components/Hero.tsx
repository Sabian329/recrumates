...
export default function Hero() {
	...
	const heroDesktopUrl = photos["hero-desktop"] ?? "";
	const heroMobileUrl = photos["hero-mobile"] ?? "";
	...
	return (
		<section
			...
			aria-label="Strona główna RecruMates – recruitment hub"
		>
			<img
				src={heroMobileUrl}
				alt="RecruMates – recruitment hub"
			...
			<header className="container relative z-10 mx-auto max-w-3xl flex-1 flex flex-col mt-12 sm:mt-0 justify-start sm:justify-center">
				<div className="text-center pt-6 md:pt-0  ">
					...
					<nav
						className="mt-6 hidden flex-row flex-wrap items-center justify-center gap-3 sm:flex"
						aria-label="Główne akcje na stronie głównej"
					>
						<a
							href="#contact"
